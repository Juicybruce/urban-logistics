...
//shows the list of completed or cancelled jobs for the merchant
...
class _historyMerchantState extends State<historyMerchant> {
  ...
  late List<dynamic>? dbdata; // database contents
  ...
  //remove an element for this history list
  ...
  //create the cards for the list items
  Card buildCard(int index, List<bool> expanded, dynamic data) {
    ...
    return Card(
      child: ListTile(
          ...
          child: Row(
            ...
            children: [
              ...
              Flexible(
                flex: 5,
                child: Column(
                  children : [ //show goods type and pickup address on card
              ...
              Flexible(
                ...
                child: FittedBox(
                  fit: BoxFit.fitWidth,
                  child: Column(
                    children : [ //show job status on card
        ...
        onTap: () {
          print("TAPPED ${index}");
          setState(() { //show expanded list elements
  ...
  Column buildSubstring(int index, dynamic data) {
    ...
    } else { //if the list is expanded show extra details.
      String cooling = "";
  ...
  //create each  row in the expanded lists
